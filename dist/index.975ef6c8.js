...
const myEmbed = new _visualEmbedSdk.PinboardEmbed(document.getElementById("embed"), {
    ...
    pinboardId: "7790a9a0-ee55-496a-a871-c4058821ffbf",
    vizId: "b3abd429-f32b-4e75-bfb3-42b15feea830"
});
myEmbed.render();

},{"@thoughtspot/visual-embed-sdk":"6UPnu"}],"6UPnu":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "init", ()=>_base.init
);
parcelHelpers.export(exports, "SearchEmbed", ()=>_search.SearchEmbed
);
parcelHelpers.export(exports, "PinboardEmbed", ()=>_pinboard.PinboardEmbed
);
parcelHelpers.export(exports, "AppEmbed", ()=>_app.AppEmbed
);
parcelHelpers.export(exports, "Page", ()=>// types
    _app.Page
);
parcelHelpers.export(exports, "AuthType", ()=>_types.AuthType
);
parcelHelpers.export(exports, "RuntimeFilterOp", ()=>_types.RuntimeFilterOp
);
parcelHelpers.export(exports, "EmbedEvent", ()=>_types.EmbedEvent
);
parcelHelpers.export(exports, "HostEvent", ()=>_types.HostEvent
);
parcelHelpers.export(exports, "DataSourceVisualMode", ()=>_types.DataSourceVisualMode
);
parcelHelpers.export(exports, "Action", ()=>_types.Action
);
/**
 * Copyright (c) 2020
 *
 ...
 */ var _app = require("./embed/app");
var _base = require("./embed/base");
var _pinboard = require("./embed/pinboard");
 ...
 * @Category App Embed
 */ parcelHelpers.export(exports, "AppEmbed", ()=>AppEmbed
);
/**
 * Copyright (c) 2021
 *
...
(function(Page1) {
     ...
     */ Page1["Answers"] = "answers";
    /**
     * Pinboards listing page
     */ Page1["Pinboards"] = "pinboards";
    /**
     * Data management page
     */ Page1["Data"] = "data";
})(Page || (Page = {
}));
class AppEmbed extends _base.V1Embed {
     ...
     */ getEmbedParams() {
        ...
        if (disabledActions === null || disabledActions === void 0 ? void 0 : disabledActions.length) params[_types.Param.DisableActions] = disabledActions;
        if (disabledActionReason) params[_types.Param.DisableActionReason] = disabledActionReason;
        if (hiddenActions === null || hiddenActions === void 0 ? void 0 : hiddenActions.length) params[_types.Param.HideActions] = hiddenActions;
        if (tag) params[_types.Param.Tag] = tag;
        const queryParams = _utils.getQueryParamString(params, true);
        return queryParams;
    }
    /**
     ...
     */ getIFrameSrc(pageId, runtimeFilters) {
        const filterQuery = _utils.getFilterQuery(runtimeFilters || []);
...
parcelHelpers.export(exports, "getQueryParamString", ()=>getQueryParamString
);
parcelHelpers.export(exports, "getCssDimension", ()=>getCssDimension
);
parcelHelpers.export(exports, "appendToUrlHash", ()=>appendToUrlHash
);
const getFilterQuery = (runtimeFilters)=>{
    if (runtimeFilters && runtimeFilters.length) {
        const filters = runtimeFilters.map((filter, valueIndex)=>{
            ...
            filterExpr.push(filter.values.map((value)=>`val${index}=${value}`
            ).join('&'));
...
const appendToUrlHash = (url, stringToAppend)=>{
    ...
    if (url.indexOf('#') >= 0) outputUrl = `${outputUrl}${encStringToAppend}`;
    else outputUrl = `${outputUrl}#${encStringToAppend}`;
    return outputUrl;
};
...
},{}],"lHa6F":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "AuthType", ()=>AuthType
);
parcelHelpers.export(exports, "RuntimeFilterOp", ()=>RuntimeFilterOp
);
parcelHelpers.export(exports, "EmbedEvent", ()=>EmbedEvent
);
parcelHelpers.export(exports, "HostEvent", ()=>HostEvent
);
parcelHelpers.export(exports, "DataSourceVisualMode", ()=>DataSourceVisualMode
);
...
(function(AuthType1) {
    ...
    /**
     * SSO using SAML
     */ AuthType1["SSO"] = "SSO_SAML";
    /**
     * Trusted authentication server
     */ AuthType1["AuthServer"] = "AuthServer";
    /**
     * Use the ThoughtSpot login API to authenticate to the cluster directly.
     *
     * Warning: This feature is primarily intended for developer testing. It is
     * strongly advised not to use this authentication method in production.
     */ AuthType1["Basic"] = "Basic";
})(AuthType || (AuthType = {
}));
var RuntimeFilterOp;
(function(RuntimeFilterOp1) {
    /**
     * Equals
     */ RuntimeFilterOp1["EQ"] = "EQ";
    /**
     * Does not equal
     */ RuntimeFilterOp1["NE"] = "NE";
    /**
     * Less than
     */ RuntimeFilterOp1["LT"] = "LT";
    /**
     * Less than or equal to
     */ RuntimeFilterOp1["LE"] = "LE";
    /**
     * Greater than
     */ RuntimeFilterOp1["GT"] = "GT";
    /**
     * Greater than or equal to
     */ RuntimeFilterOp1["GE"] = "GE";
    /**
     * Contains
     */ RuntimeFilterOp1["CONTAINS"] = "CONTAINS";
    /**
     * Begins with
     */ RuntimeFilterOp1["BEGINS_WITH"] = "BEGINS_WITH";
    /**
     * Ends with
     */ RuntimeFilterOp1["ENDS_WITH"] = "ENDS_WITH";
    /**
     * Between, inclusive of higher value
     */ RuntimeFilterOp1["BW_INC_MAX"] = "BW_INC_MAX";
    /**
     * Between, inclusive of lower value
     */ RuntimeFilterOp1["BW_INC_MIN"] = "BW_INC_MIN";
    /**
     * Between, inclusive of both higher and lower value
     */ RuntimeFilterOp1["BW_INC"] = "BW_INC";
    /**
     * Between, non-inclusive
     */ RuntimeFilterOp1["BW"] = "BW";
    /**
     * Is included in this list of values
     */ RuntimeFilterOp1["IN"] = "IN";
})(RuntimeFilterOp || (RuntimeFilterOp = {
}));
var EmbedEvent;
(function(EmbedEvent1) {
    /**
     * Rendering has initialized.
     * @return timestamp - The timestamp when the event was generated.
     */ EmbedEvent1["Init"] = "init";
    /**
     * Authentication has either succeeded or failed.
     * @return isLoggedIn - A Boolean specifying whether authentication was successful.
     */ EmbedEvent1["AuthInit"] = "authInit";
    /**
     ...
     */ EmbedEvent1["Drilldown"] = "drillDown";
    /**
     * One or more data sources have been selected.
     * @return dataSourceIds - the list of data sources
     */ EmbedEvent1["DataSourceSelected"] = "dataSourceSelected";
    /**
     * A custom action has been triggered
     * @return actionId - The id of the custom action
     * @return data - The answer or pinboard data
     */ EmbedEvent1["CustomAction"] = "customAction";
    /**
     * An error has occurred.
     * @return error - An error object or message
     */ EmbedEvent1["Error"] = "Error";
    /**
     * The embedded object has sent an alert
     * @return alert - An alert object
     */ EmbedEvent1["Alert"] = "alert";
    /**
     * The ThoughtSpot auth session has expired.
     * @hidden
     */ EmbedEvent1["AuthExpire"] = "ThoughtspotAuthExpired";
    /**
     ...
     */ EmbedEvent1["EmbedHeight"] = "EMBED_HEIGHT";
    /**
     * The v1 event type for Data
     * @hidden
     */ EmbedEvent1["V1Data"] = "exportVizDataToParent";
    /**
     * Emitted when the embed does not have cookie access. This
     * happens on Safari where third-party cookies are blocked by default.
     *
     * @version 1.1.0
     */ EmbedEvent1["NoCookieAccess"] = "noCookieAccess";
    /**
     * Emitted when SAML is complete
     * @private
     * @hidden
     */ EmbedEvent1["SAMLComplete"] = "samlComplete";
...
(function(HostEvent1) {
     ...
     */ HostEvent1["Search"] = "search";
    /**
     * Apply filters
     * @hidden
     */ HostEvent1["Filter"] = "filter";
    /**
     * Reload the answer or visualization
     * @hidden
     */ HostEvent1["Reload"] = "reload";
})(HostEvent || (HostEvent = {
}));
var DataSourceVisualMode;
(function(DataSourceVisualMode1) {
    /**
     * Data source panel is hidden.
     */ DataSourceVisualMode1["Hidden"] = "hide";
    /**
     * Data source panel is collapsed, but the user can manually expand it.
     */ DataSourceVisualMode1["Collapsed"] = "collapse";
    /**
     * Data source panel is expanded, but the user can manually collapse it.
     */ DataSourceVisualMode1["Expanded"] = "expand";
})(DataSourceVisualMode || (DataSourceVisualMode = {
}));
var Param;
(function(Param1) {
    Param1["DataSources"] = "dataSources";
    Param1["DataSourceMode"] = "dataSourceMode";
    Param1["DisableActions"] = "disableAction";
    Param1["DisableActionReason"] = "disableHint";
    Param1["SearchQuery"] = "searchQuery";
    Param1["HideActions"] = "hideAction";
    Param1["EnableVizTransformations"] = "enableVizTransform";
    Param1["EnableSearchAssist"] = "enableSearchAssist";
    Param1["HideResult"] = "hideResult";
    Param1["UseLastSelectedDataSource"] = "useLastSelectedSources";
    Param1["Tag"] = "tag";
    Param1["searchTokenString"] = "searchTokenString";
    Param1["executeSearch"] = "executeSearch";
})(Param || (Param = {
}));
var Action;
(function(Action1) {
    Action1["Save"] = "save";
    Action1["Update"] = "update";
    Action1["SaveUntitled"] = "saveUntitled";
    Action1["SaveAsView"] = "saveAsView";
    Action1["MakeACopy"] = "makeACopy";
    Action1["EditACopy"] = "editACopy";
    Action1["CopyLink"] = "embedDocument";
    Action1["PinboardSnapshot"] = "pinboardSnapshot";
    Action1["ResetLayout"] = "resetLayout";
    Action1["Schedule"] = "schedule";
    Action1["SchedulesList"] = "schedule-list";
    Action1["Share"] = "share";
    Action1["AddFilter"] = "addFilter";
    Action1["ConfigureFilter"] = "configureFilter";
    Action1["AddFormula"] = "addFormula";
    Action1["SearchOnTop"] = "searchOnTop";
    Action1["SpotIQAnalyze"] = "spotIQAnalyze";
    Action1["ExplainInsight"] = "explainInsight";
    Action1["SpotIQFollow"] = "spotIQFollow";
    Action1["ShareViz"] = "shareViz";
    Action1["ReplaySearch"] = "replaySearch";
    Action1["ShowUnderlyingData"] = "showUnderlyingData";
    Action1["Download"] = "download";
    Action1["DownloadAsPdf"] = "downloadAsPdf";
    Action1["DownloadAsCsv"] = "downloadAsCSV";
    Action1["DownloadAsXlsx"] = "downloadAsXLSX";
    Action1["DownloadTrace"] = "downloadTrace";
    Action1["ExportTML"] = "exportTSL";
    Action1["ImportTML"] = "importTSL";
    Action1["UpdateTML"] = "updateTSL";
    Action1["EditTML"] = "editTSL";
    Action1["Present"] = "present";
    Action1["ToggleSize"] = "toggleSize";
    Action1["Edit"] = "edit";
    Action1["EditTitle"] = "editTitle";
    Action1["Remove"] = "delete";
    Action1["Ungroup"] = "ungroup";
    Action1["Describe"] = "describe";
    Action1["Relate"] = "relate";
    Action1["CustomizeHeadlines"] = "customizeHeadlines";
    Action1["PinboardInfo"] = "pinboardInfo";
    Action1["SendAnswerFeedback"] = "sendFeedback";
    Action1["CustomAction"] = "customAction";
    Action1["DownloadEmbraceQueries"] = "downloadEmbraceQueries";
    Action1["Pin"] = "pin";
    Action1["AnalysisInfo"] = "analysisInfo";
    Action1["Subscription"] = "subscription";
    Action1["Explore"] = "explore";
    Action1["DrillInclude"] = "context-menu-item-include";
    Action1["DrillExlude"] = "context-menu-item-exclude";
    Action1["CopyToClipboard"] = "context-menu-item-copy-to-clipboard";
    Action1["DrillEdit"] = "context-menu-item-edit";
    Action1["EditMeasure"] = "context-menu-item-edit-measure";
    Action1["Separator"] = "context-menu-item-separator";
    Action1["DrillDown"] = "DRILL";
})(Action || (Action = {
}));

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"96H72":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
 ...
 * React+GraphQL
 */ parcelHelpers.export(exports, "TsEmbed", ()=>TsEmbed
);
/**
 * Base class for embedding v1 experience
 * Note: The v1 version of ThoughtSpot Blink works on the AngularJS stack
 * which is currently under migration to v2
 */ parcelHelpers.export(exports, "V1Embed", ()=>V1Embed
);
/**
 * Copyright (c) 2021
 *
...
var _mixpanelService = require("../mixpanel-service");
let config = {
};
let authPromise;
/**
 ...
 * @internal
 */ const V1EventMap = {
    [_types.EmbedEvent.Data]: [
        _types.EmbedEvent.V1Data
    ]
};
/**
 ...
 */ const handleAuth = ()=>{
    const authConfig = {
        ...config,
        thoughtSpotHost: _config.getThoughtSpotHost(config)
    };
    authPromise = _auth.authenticate(authConfig);
};
const init = (embedConfig)=>{
    config = embedConfig;
    handleAuth();
    _mixpanelService.initMixpanel(embedConfig);
};
class TsEmbed {
    constructor(domSelector, viewConfig){
        this.el = this.getDOMNode(domSelector);
        // TODO: handle error
        this.thoughtSpotHost = _config.getThoughtSpotHost(config);
        this.thoughtSpotV2Base = _config.getV2BasePath(config);
     ...
     */ handleError(error) {
        this.isError = true;
        this.executeCallbacks(_types.EmbedEvent.Error, {
            error
        });
        // Log error
        console.log(error);
     ...
     */ subscribeToEvents() {
        window.addEventListener('message', (event)=>{
            ...
            if (event.source === this.iFrame.contentWindow) this.executeCallbacks(eventType, event.data);
        });
    }
    /**
     ...
     */ renderIFrame(url, frameOptions) {
        ...
        if (!this.thoughtSpotHost) this.throwInitError();
        url.length;
        const initTimestamp = Date.now();
        this.executeCallbacks(_types.EmbedEvent.Init, {
            data: {
                timestamp: initTimestamp
            }
        });
        _mixpanelService.uploadMixpanelEvent(_mixpanelService.MIXPANEL_EVENT.VISUAL_SDK_RENDER_START);
        authPromise === null || authPromise === void 0 || authPromise.then(()=>{
            this.executeCallbacks(_types.EmbedEvent.AuthInit, {
                data: {
            ...
            const width = _utils.getCssDimension((frameOptions === null || frameOptions === void 0 ? void 0 : frameOptions.width) || _config.DEFAULT_EMBED_WIDTH);
            const height = _utils.getCssDimension((frameOptions === null || frameOptions === void 0 ? void 0 : frameOptions.height) || _config.DEFAULT_EMBED_HEIGHT);
            ...
            this.iFrame.addEventListener('load', ()=>{
                ...
                this.executeCallbacks(_types.EmbedEvent.Load, {
                    data: {
                        timestamp: loadTimestamp
                    }
                });
                _mixpanelService.uploadMixpanelEvent(_mixpanelService.MIXPANEL_EVENT.VISUAL_SDK_IFRAME_LOAD_PERFORMANCE, {
     ...
     */ on(messageType, callback) {
        if (this.isRendered) this.handleError('Please register event handlers before calling render');
...
parcelHelpers.export(exports, "getV2BasePath", ()=>getV2BasePath
);
parcelHelpers.export(exports, "URL_MAX_LENGTH", ()=>URL_MAX_LENGTH
);
parcelHelpers.export(exports, "DEFAULT_EMBED_WIDTH", ()=>DEFAULT_EMBED_WIDTH
);
parcelHelpers.export(exports, "DEFAULT_EMBED_HEIGHT", ()=>DEFAULT_EMBED_HEIGHT
);
...
const getThoughtSpotHost = (config)=>{
    ...
    if (!urlParts) throw new Error(_errors.ERROR_MESSAGE.INVALID_THOUGHTSPOT_HOST);
...
const getV2BasePath = (config)=>{
    ...
    if (tsHost.includes('://localhost')) return '';
    return 'v2';
};
...
},{"./errors":"k9i6l","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k9i6l":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cr4Z4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "EndPoints", ()=>EndPoints
);
parcelHelpers.export(exports, "doTokenAuth", ()=>doTokenAuth
);
parcelHelpers.export(exports, "doBasicAuth", ()=>doBasicAuth
);
parcelHelpers.export(exports, "doSamlAuth", ()=>doSamlAuth
);
...
const doTokenAuth = async (embedConfig)=>{
    ...
    if (!authEndpoint && !getAuthToken) throw new Error('Either auth endpoint or getAuthToken function must be provided');
    const loggedIn = await isLoggedIn(thoughtSpotHost);
    if (!loggedIn) {
        let authToken = null;
        if (getAuthToken) authToken = await getAuthToken();
        else authToken = await fetch(authEndpoint).then((response)=>response.text()
        );
...
async function samlPopupFlow(ssoURL) {
    ...
    samlCompletionPromise = samlCompletionPromise || new Promise((resolve, reject)=>{
        window.addEventListener('message', (e)=>{
            if (e.data.type === _types.EmbedEvent.SAMLComplete) {
                e.source.close();
                resolve();
            }
        });
    ...
    authElem.addEventListener('click', ()=>{
        if (samlAuthWindow === null || samlAuthWindow.closed) samlAuthWindow = window.open(ssoURL, '_blank', 'location=no,height=570,width=520,scrollbars=yes,status=yes');
        else samlAuthWindow.focus();
    }, {
        once: true
    });
    authElem.click();
...
const doSamlAuth = async (embedConfig)=>{
    ...
    const loggedIn = await isLoggedIn(thoughtSpotHost);
    if (loggedIn) {
        if (isAtSSORedirectUrl()) removeSSORedirectUrlMarker();
        loggedInStatus = true;
        return;
    }
    ...
    const ssoRedirectUrl = embedConfig.noRedirect ? `${thoughtSpotHost}/v2/#/embed/saml-complete` : _utils.appendToUrlHash(window.location.href, SSO_REDIRECTION_MARKER_GUID);
...
const authenticate = async (embedConfig)=>{
    ...
    switch(authType){
        case _types.AuthType.SSO:
            return doSamlAuth(embedConfig);
        case _types.AuthType.AuthServer:
            return doTokenAuth(embedConfig);
        case _types.AuthType.Basic:
...
},{"./types":"lHa6F","./utils":"hpbba","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7y0fn":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "EndPoints", ()=>EndPoints
);
parcelHelpers.export(exports, "MIXPANEL_EVENT", ()=>MIXPANEL_EVENT
);
/**
 * Pushes the event with its Property key-value map to mixpanel.
 * @param eventId
 * @param eventProps
 */ parcelHelpers.export(exports, "uploadMixpanelEvent", ()=>uploadMixpanelEvent
);
parcelHelpers.export(exports, "initMixpanel", ()=>initMixpanel
);
...
async function uploadMixpanelEvent(eventId, eventProps = {
    ...
    return new Promise(()=>_mixpanelBrowser.track(eventId, eventProps)
    );
}
function emptyQueue() {
...
async function initMixpanel(config) {
    ...
    return fetch(`${thoughtSpotHost}${EndPoints.CONFIG}`).then((response)=>response.json()
    ).then((data)=>{
        const token = data.mixpanelAccessToken;
        if (token) {
            _mixpanelBrowser.init(token);
            setEventCollectorOn();
            emptyQueue();
    ...
    function getElementsBySelector(selector) {
        ...
        for(i = 0; i < tokens.length; i++){
            ...
            if (token.indexOf('.') > -1) {
                ...
                for(j = 0; j < found.length; j++)if (found[j].className && _.isString(found[j].className) && hasClass(found[j], className)) currentContext[currentContextIndex++] = found[j];
                continue; // Skip to next token
            }
...
_.info = {
     ...
     */ browserVersion: function(userAgent1, vendor, opera) {
        var browser = _.info.browser(userAgent1, vendor, opera);
        var versionRegexs = {
        ...
        var matches = userAgent1.match(regex);
 ...
 */ RequestBatcher.prototype.flush = function(options) {
    try {
        ...
        _.each(batch, function(item) {
            ...
            if (payload) dataForRequest.push(payload);
        ...
        var batchSendCallback = _.bind(function(res) {
            ...
            try {
                ...
                removeItemsFromQueue = true;
                if (removeItemsFromQueue) this.queue.removeItemsByID(_.map(batch, function(item) {
                    return item['id'];
...
*/ MixpanelPeople.prototype.set = addOptOutCheckMixpanelPeople(function(prop, to, callback) {
    ...
    }, _.info.people_properties(), this._mixpanel['persistence'].get_referrer_info(), data[SET_ACTION]);
    return this._send_request(data, callback);
});
/*
...
MixpanelPeople.prototype._flush_one_queue = function(action, action_method, callback, queue_to_params_fn) {
    ...
    }, this._mixpanel['persistence']._get_queue(action));
...
MixpanelPersistence.prototype._get_or_create_queue = function(queue, default_val) {
    ...
    default_val = _.isUndefined(default_val) ? {
    } : default_val;
...
MixpanelLib.prototype._init = function(token, config, name) {
    ...
    }, DEFAULT_CONFIG, variable_features, config, {
        'name': name,
        'token': token,
 ...
 */ MixpanelLib.prototype.track = addOptOutCheckMixpanelLib(function(event_name, properties, options, callback) {
    ...
    properties = _.extend({
    }, _.info.properties(), this['persistence'].properties(), this.unpersisted_superprops, properties);
 ...
 */ MixpanelLib.prototype.track_pageview = function(page) {
    if (_.isUndefined(page)) page = document$1.location.href;
 ...
 */ parcelHelpers.export(exports, "PinboardEmbed", ()=>PinboardEmbed
);
/**
 * Copyright (c) 2021
 *
...
var _utils = require("../utils");
var _base = require("./base");
class PinboardEmbed extends _base.V1Embed {
    // eslint-disable-next-line no-useless-constructor
    constructor(domSelector, viewConfig){
        super(domSelector, viewConfig);
        /**
     ...
     */ getEmbedParams() {
        ...
        if (disabledActionReason) params[_types.Param.DisableActionReason] = disabledActionReason;
        if (hiddenActions === null || hiddenActions === void 0 ? void 0 : hiddenActions.length) params[_types.Param.HideActions] = hiddenActions;
        if (enableVizTransformations !== undefined) params[_types.Param.EnableVizTransformations] = enableVizTransformations.toString();
        const queryParams = _utils.getQueryParamString(params, true);
        return queryParams;
    }
    /**
     ...
     */ render() {
        ...
        if (!pinboardId && !vizId) this.handleError(_errors.ERROR_MESSAGE.PINBOARD_VIZ_ID_VALIDATION);
        if (this.viewConfig.fullHeight === true) this.on(_types.EmbedEvent.EmbedHeight, this.updateIFrameHeight);
        super.render();
